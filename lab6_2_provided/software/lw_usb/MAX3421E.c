...
void MAXreg_wr(BYTE reg, BYTE val)
{
	...
	int return_code = XSpi_Transfer(&SpiInstance, transmit_buf, NULL, 2);
...
BYTE *MAXbytes_wr(BYTE reg, BYTE nbytes, BYTE *data)
{
	...
	int return_code = XSpi_Transfer(&SpiInstance, transmit_buf, NULL, 1 + nbytes);
...
BYTE MAXreg_rd(BYTE reg)
{
	...
	int return_code = XSpi_Transfer(&SpiInstance, transmit_buf, receive_buf, 2); // force 2
...
BYTE *MAXbytes_rd(BYTE reg, BYTE nbytes, BYTE *data)
{
	...
	int return_code = XSpi_Transfer(&SpiInstance, transmit_buf, receive_buf, 2 + nbytes); //*simul transmition, takes 2 bytes for transmit, remaining for return and overlaps 1
