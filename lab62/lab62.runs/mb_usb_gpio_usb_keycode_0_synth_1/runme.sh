...
HD_PWD='C:/Users/jkali/ece385/lab6/lab62/lab62.runs/mb_usb_gpio_usb_keycode_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_usb_gpio_usb_keycode_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_usb_gpio_usb_keycode_0.tcl
